...
export default function Feedback() {
  ...
  // 2. Filter to grab ALL completed mock interviews with AI reports
  ...
  // 3. Calculate Average Score (out of 100) and convert to a 5-Star Rating
  ...
  // 4. Calculate Improvement (Compare most recent score to the previous score)
  let improvement = 0;
  if (totalFeedback > 1) {
  ...
  return (
    <Card className="border-0 shadow-sm bg-white dark:bg-gray-900 h-full flex flex-col">
      ...
      <CardContent className="space-y-6 flex-1 min-h-0 flex flex-col">
        ...
        {/* THE LIST: Recent Feedback mapped dynamically */}
        <div className="space-y-3 flex-1 overflow-y-auto pr-2 min-h-0">
          ...
          {!hasAttended ? (
            ...
            // Grab exactly the 3 most recent interviews
        ...
        {/* Overall Capability Progress Bar */}
        <div className="flex-shrink-0 pt-4 border-t border-gray-100 dark:border-gray-700 mt-auto">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Overall Capability</span>
            <span className={`text-sm font-semibold ${averageScore >= 80 ? 'text-green-600' : averageScore >= 60 ? 'text-yellow-600' : 'text-blue-600'}`}>{averageScore}%</span>
          </div>
          <Progress value={averageScore} className="h-2.5 bg-gray-200 dark:bg-gray-700" indicatorClassName={`${averageScore >= 80 ? 'bg-green-600' : averageScore >= 60 ? 'bg-yellow-500' : 'bg-blue-600'}`} />
...
// -------------------------------------------------------------
// The Detailed Analysis Modal (Pops up when clicking "Details →")
// -------------------------------------------------------------
      ...
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border-0">
        ...
        <div className="py-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="col-span-2 bg-blue-50/50 dark:bg-blue-900/10 rounded-xl p-6 border border-blue-100 dark:border-blue-900">
